...
import { contactFr } from '@/data/dataFr';
...
const Contact: FC = memo(() => {
  ...
  const contactData = lang == "fr" ? contactFr : contact

  const SectionData = lang == "fr" ? SectionIdFr : SectionId

  const { headerText, description, items } = contactData;
  return (
    <Section className="bg-neutral-900" sectionId={SectionData.Contact}>
